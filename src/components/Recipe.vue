      ...
      <b-row class="">
        <b-col class="">
          <div class="pt-3 mt-2 pb-3 mb-2 border border-left-0 border-right-0">
            ...
            <div class="d-inline d-sm-inline mr-4"><span class="text-primary mr-1">Makes</span> {{ loaves(recipe.numberOfLoaves) }}</div>
          ...
          <b-card no-body>
            <b-card-body v-for="step of recipe.steps" class="border mb-4 border-left-0 border-right-0 border-top-0 ">
              ...
              <b-row>
                ...
                <b-col md="6" v-html="stepImage(step)"></b-col>
              </b-row>
            </b-card-body>
            <b-card-body class="border mb-4 border-left-0 border-right-0 border-top-0 ">
              <b-row>
                <b-col>
...
export default {
  ...
  methods: {
    ...
    stepImage: function (step) {
      ...
      if (step.category.toLowerCase().match(/levain/gi) !== null) return start + this.thumbnail('static/levain-sm.jpg') + end
