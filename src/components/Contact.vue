  ...
  <div class="add-recipe container container-sm pt-5">
    <b-row class="pb-5 mb-5" style="border-bottom:1px solid #bbb">
      ...
      <b-col sm="6">
        ...
        <p>
          We started using Google Docs and recipe websites, double-checking ingredients, and trying to calculate the right time for each step. But we wanted a tool to handle this for me. And that's why we made <a href="/"><span class="text-primary"><timer-icon></timer-icon>Bread Scheduler</span></a>.
        </p>
      </b-col>
    </b-row>
    <b-row>
