  ...
  <div id="app" class="">
    <div class="app-wrap">
      <div :class="timerClasses">
        ...
        <div class="pl-3 pr-3 pt-2 pb-2">
            ...
            <!-- <b-btn variant="link text-secondary" @click="resetTimer" size="sm">Reset</b-btn> -->
          <!-- <p class="mb-0 pb-0">
            <strong class="text-strong text-small">Adjust by 10 minutes</strong>
          </p>
          <p class="">
            <b-btn variant="secondary" @click="adjustTime(-10)" size="sm"><minus-icon></minus-icon> 10 m</b-btn>
            <b-btn variant="secondary" @click="adjustTime(10)" size="sm"><plus-icon></plus-icon> 10 m</b-btn>
          </p> -->
      ...
      <div class="nav-bar ml-0 mr-0 ml-sm-5 mr-sm-5 p-3 text-dark text-large">
        ...
        <!-- <div class="float-right mt-1 ml-4"><router-link to="/about" class="text-dark">How to use</router-link></div> -->
        <!-- <div class="float-right mt-1 ml-4"><router-link to="/recipes/add" class="text-dark"><plus-icon></plus-icon>Quick plan</router-link></div> -->
        <!-- <div class="float-right mt-1 ml-4"><router-link to="/recipes/add" class="text-dark"><plus-icon></plus-icon>Add a recipe</router-link></div> -->
      </div>
    ...
    <footer class="footer mt-5 page-footer bg-dark text-light">
      <!-- <div class="container p-5">
        <div class="row">
          <div class="col col-4">
            <h3>Bread Scheduler</h3>
            <p class="text-thin">
              Bread recipes, planner and timer for better sourdough. An easy way to plan your bakes.
            </p>
          </div>
        </div>
      </div> -->
